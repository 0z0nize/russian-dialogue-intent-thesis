...
Для автоматического создания структуры папок используйте ноутбук [`notebooks/00_create_drive_folders.ipynb`](notebooks/00_create_drive_folders.ipynb) в Google Colab. Альтернативно структуру можно создать вручную.
